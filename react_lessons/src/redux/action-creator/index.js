import {SET_SEARCH, SET_SEARCHPAGINATION, SET_SEARCHTEXT, SET_GENRES, SET_SEARCHLOAD, SET_SORTLIST} from "../action-type";
...
export const setSortList = (payload) => ({type: SET_SORTLIST, payload});
